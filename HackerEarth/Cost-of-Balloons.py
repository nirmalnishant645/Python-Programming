...
This contest consists of two problems and  participants.
...
For example, if the value of the jth integer in the ith row is 0, then it depicts that the ith participant has not solved the jth problem.
